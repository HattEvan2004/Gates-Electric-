  ...
  return (
    <section id="about" className="py-24 bg-brand-dark relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <h3 className="text-3xl md:text-5xl font-bold text-white mb-8 leading-tight">{site?.aboutHeading || 'Your Local Partner for Quality Electrical Work'}</h3>
