  ...
  return (
    <div className="relative bg-brand-dark overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="pt-20 pb-24 md:pt-32 md:pb-40 flex flex-col lg:flex-row lg:items-center lg:gap-16">
        ...
        <div className="w-full mt-12 lg:mt-0 lg:w-1/2 flex justify-center">
          <img src="/hero.png" alt="Gates Electric electrical work" className="w-full max-w-2xl aspect-[4/3] object-cover object-center rounded-2xl border border-white/10 shadow-2xl" />
        </div>
