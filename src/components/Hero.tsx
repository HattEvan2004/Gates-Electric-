  ...
  return (
    <div className="relative bg-brand-dark overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:w-[45%]">
        ...
        <div className="w-full mt-12 lg:mt-0 lg:w-[55%] flex justify-center">
          <img src="/hero.png" alt="Gates Electric electrical work" className="w-full max-w-xl h-auto rounded-2xl border border-white/10 shadow-2xl" />
        </div>
